...
async function main() {
  ...
  const lessons = [
    { id: 'lesson_1', title: 'Blink the LED', description: 'Learn to blink an LED!', level: 1, order: 1, components: ['Arduino Uno','LED','220Ω'], codeExample: 'void setup(){pinMode(13,OUTPUT);Serial.begin(9600);}\nvoid loop(){digitalWrite(13,HIGH);Serial.println("LED:1");delay(1000);digitalWrite(13,LOW);Serial.println("LED:0");delay(1000);}', gameConfig: { gameType: 'energy_city' }, winCondition: { type: 'led_blink_count', count: 5 }, xpReward: 50, published: true },
