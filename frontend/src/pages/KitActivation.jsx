    ...
    <div className="min-h-screen bg-dark-900 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg">
        <div className="text-center mb-8">
          ...
          <p className="text-dark-400 mt-2">Aktivlashtirish kodini kiriting from your STEMVERSE kit</p>
        </div>
        {activated ? (
          <div className="card-glow text-center p-8">
            ...
            <h2 className="text-2xl font-game text-white mb-4">Kit Aktivlashtirishd! 🎉</h2>
          ...
          <div className="card-glow">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button type="submit" disabled={loading || code.length < 3} className="btn-neon w-full flex items-center justify-center gap-2">
                ...
                {loading ? 'Activating...' : 'Aktivlashtirish'}
              </button>
            </form>
            <div className="mt-6">
