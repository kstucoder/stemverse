...
const stories = {
  ...
  distance_radar: {
    ...
    hero: 'Qalqon',
    heroEmoji: '🛡️',
    role: 'Qalqon operatori',
    mission: 'Ultrasonik sensor bilan energiya qalqonini boshqarib, meteorlarni qaytaring va shaharni saqlang!',
    problem: '☄️ Shahar ustida meteor yomg\'iri',
    solution: '🛡️ Qalqonni meteor balandligiga surib qaytar',
    climax: '12 meteor qaytarildi! Shahar himoyalandi!',
  },
  reaction_champion: {
  ...
  piano_player: {
    ...
    hero: 'Signal',
    heroEmoji: '🎵',
    role: 'Signal muhandisi',
    mission: '4 tugma va buzzer bilan rezonans melodiyasini chalib, signal mayog\'ini yoqing va omon qolganlarni chaqiring!',
    problem: '📡 Shahar jim — omon qolganlar tarqoq',
    solution: '🎵 Rezonans melodiyasi bilan mayoqni yoqish',
    climax: 'Mayoq yondi! Signal uzatildi — hamma uyga qaytmoqda!',
  },
  parking_assistant: {
    title: 'Ta\'minot Doklash',
    hero: 'Dock',
    heroEmoji: '🛰️',
    role: 'Doklash operatori',
    mission: 'Ultrasonik sensor bilan ta\'minot podlarini bazaga aniq dokla — bazani ta\'minla!',
    problem: '📦 Avtomatik doklash ishdan chiqqan',
    solution: '📡 Masofani o\'lchab qo\'lda doklash',
    climax: 'Baza ta\'minlandi! 5 pod muvaffaqiyatli doklandi!',
  },
  motion_alarm: {
    title: 'Xavfsizlik Tizimi',
    hero: 'Guardian',
    heroEmoji: '🛡️',
    role: 'Xavfsizlik boshlig\'i',
    mission: 'PIR harakat sensori bilan bazaning tungi perimetrini qo\'riqlab, skavenjer dronlarni qaytaring!',
    problem: '🌙 Tunda dronlar perimetrga yaqinlashmoqda',
    solution: '📡 PIR harakat sensori bilan aniqlash',
    climax: '10 ta dron qaytarildi — perimetr xavfsiz!',
  },
  music_visualizer: {
    title: 'Ovoz ranglari',
    hero: 'Spectra',
  ...
  obstacle_course: {
    title: 'Meteor Qalqoni',
    hero: 'Shield',
    heroEmoji: '☄️',
    role: 'Bosh himoyachi',
    mission: 'Potensiometr bilan zenit to\'pini nishonlab, tugma bilan meteorlarni otib bazani saqlang!',
    problem: '☄️ Asteroidning so\'nggi meteor to\'dasi',
    solution: '🎯 Nishonlab otish bilan mudofaa',
    climax: 'Meteor to\'dasi qaytarildi! Baza saqlab qolindi!',
  },
  weather_station: {
