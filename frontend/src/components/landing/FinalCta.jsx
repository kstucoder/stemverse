      ...
      <div className="wrap">
        ...
        <div className="hero-cta">
          <Link to="/activate" className="btn btn-amber" style={{ fontSize: '1rem' }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="m21 2-1 9H10L8 2"/><path d="M17 16a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2 4 4 0 0 1 4-4h2a4 4 0 0 1 4 4z"/><circle cx="8" cy="5" r="2"/></svg>
            To'plamni faollashtirish
          </Link>
          <Link to="/auth/register" className="btn btn-primary">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M5 3l14 9-14 9V3z"/></svg>
