export default function FaqSection() {
  const faqs = [
    ...
    { q: "To'plam ichida nima bor?", a: "Boshqaruv platasi, bredbord, jumperlar, LED, servo, ultratovush sensor, LDR, RGB, tugmalar, sensorlar, zummer va USB kabel — barcha 20 missiya uchun hammasi." },
